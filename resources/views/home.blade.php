...
<head>
    ...
    <title> Artículos Innovadores Leo | Distribuidores 3M, Sika, Makita, Mapei</title>
	...
	<section class="top_header_area">
	    <div class="container">
            <ul class="nav navbar-nav top_nav">
                <li><a href="#"><i class="fa fa-phone"></i>(55) 2235-5565</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i>ventas@ail.com.mx</a></li>
                <li><a href="#"><i class="fa fa-clock-o"></i>Lun - Sab 08:30 - 18:00</a></li>
            </ul>
        ...
        <div class="container">
            ...
            <div class="searchForm">
                <form action="#" class="row m0">
                    <div class="input-group">
                        ...
                        <input type="search" name="search" class="form-control" placeholder="¿Qué producto buscas?">
            ...
            <div class="col-md-4 p0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html" style="padding-top:5px !important;">
        ...
        <div class="slider_inner">
            <div data-thumb="images/slider-1.jpg" data-src="images/slider-1.jpg">
                <div class="camera_caption">
                   <div class="container">
                        <h1 class="h1 wow fadeInUp animated">Distribuidores Autorizados 3m, SIKA, MAKITA, MAPEI</h1>
                        <h3 class=" wow fadeInUp animated" data-wow-delay="0.5s" style="color:#f6b60b">ARTÍCULOS INNOVADORES LEO</h3>
                        <p class=" wow fadeInUp animated" data-wow-delay="0.8s">
                            Contamos con los mejores productos del mercado <strong>INDUSTRIAL Y CONSTRUCCIÓN</strong>
                        </p>
